...
In order to get it up and running, you have to use our PC patcher (read more about that below) and follow instructions set in the [WiiLink Discord](https://discord.gg/rc24). There is no wii.guide page for this.
