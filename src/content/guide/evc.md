...
5. Highlight the WADs with `Everybody Votes Channel (RiiConnect24)` and `Region Select (RiiConnect24)` as its name and press + to select it. When it is selected, press A twice to install the WADs.
...
<l class="notice generic fullwidth">If you happen to get `Error -1022/Error -1029` when installing `Everybody Votes Channel (RiiConnect24)` or `Region Select (RiiConnect24)`, uninstall the channels by selecting the WAD with `-` and pressing `A`. Then, re-install the WAD.</l>
