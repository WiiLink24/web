...
title: News Channel
pubDate: 2024-10-02
description: Get up-to-date instructions on how to patch the News Channel!
...
2. Highlight the WAD `News Channel` as its name and press + to select it. When it is selected, press A twice to install the WADs.
