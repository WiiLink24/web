...
<l class="notice generic fullwidth"> This guide is for installing the [Dominos](#installation-guide-dominos) version of the Food Channel. If you want to install the Standard (Fake Ordering) version, please read the regular [Installation Guide](/guide/1install/), and choose the Standard version in the patcher. </l>
