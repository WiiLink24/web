...
> No, WiiLink cannot see your address. The only time WiiLink receives it is when you place an order, where it is sent straight to the provider (e.g. Dominos), not us.
